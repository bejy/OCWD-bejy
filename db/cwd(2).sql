...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 15, 2019 at 01:05 AM
...
INSERT INTO `billing` (`b_id`, `billing_id`, `account_no`, `present_reading`, `previous_reading`, `due_date`, `cutting_date`, `bill_amount`) VALUES
(1, 1, 1, '1', '0', '2019-03-12', '2019-03-14', 2);
...
(4, 1, 'brian', 'barredo', 'cabantac', '2019-03-12', 'fbbhatatr', 'single', '090978785', 'studner', 'mam', 'paap', 'bant', '3', 'tuyabang', 'oro', 'residential', 'public', '', '', '33332', '2019-03-14', '123avs', '423'),
(5, 2, 'wer', 'werwe', 'werwer', '2019-03-06', 'wrwerwerwe', 'married', '23423423', 'erwer', 'atat', 'atat', 'atata', '5', 'tatat', 'tatat', 'commercial', 'private', 'on', 'on', '234234', '2019-03-27', 'wrwer2342', '4234234');
...
ALTER TABLE `payment`
  ...
  ADD KEY `billing_id` (`billing_id`,`account_no`,`seniorpwd`,`penalty`),
  ADD KEY `penalty` (`penalty`),
  ADD KEY `seniorpwd` (`seniorpwd`),
  ADD KEY `account_no` (`account_no`);
...
--
ALTER TABLE `payment`
  MODIFY `reciept_no` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `payment`
  ADD CONSTRAINT `payment_ibfk_3` FOREIGN KEY (`penalty`) REFERENCES `penalty` (`id_penalty`),
  ADD CONSTRAINT `payment_ibfk_4` FOREIGN KEY (`seniorpwd`) REFERENCES `seniorpwd` (`id`),
  ADD CONSTRAINT `payment_ibfk_5` FOREIGN KEY (`account_no`) REFERENCES `consumer1` (`account_no`);
