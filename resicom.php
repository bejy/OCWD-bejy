...
<div class="row">
  <div class="col-md-12">
    <ul class="stepper stepper-horizontal">
      ...
      <li class="active">
        <a href="read.php">
          <span class="circle">RC</span>
          <span class="label">ResiCom</span>
        </a>
      </li>
      <li>
      </li>
	...
	<table width="600px">
		...
		<div class="form-row">
			...
			<div class="col-md-4">
				<a href="payment.php" class="btn btn-info btn-rounded btn-lg">Residentials</a>
			</div>
			<div class="col-md-4">
				<a href="payment1.php" class="btn btn-info btn-rounded btn-lg">Commercials</a>
			</div>
		</div>
	</td>
	</table>
