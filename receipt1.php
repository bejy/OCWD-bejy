...
<body>
<form method="post" action="receipt1.php"/>
<header>
...
<td>
  <tbody>
	...
	<tr>
      <th>Amount</th>
     <th> <h1><?php echo '₱'.($row['present_reading']-$row['previous_reading'])*($row['commercial']/10);?></h1></th>
     </h1></th>
    </tr>
	</tbody>
	<?php } ?>
