...
<body>
<form method="post" action="billing1.php"/>
<header>
...
<td>
	...
	<div class="form-row">
		...
		<div class="form-row">
			...
			<input  class="form-control form-control-lg" type="text" name="previous_reading" value="<?php echo $row['present_reading']; ?>"readonly/>
		</div >
		<div class="col-md-5">
