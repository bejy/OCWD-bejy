<?php
	...
	if (isset($_GET['searchbutton'])) {
		$search = mysqli_real_escape_string($_POST['textsearch']);
		$sql = "SELECT * FROM consumer1 WHERE account_no  LIKE '%$search%' OR fname  LIKE '%$search%' mname  LIKE '%$search%' lname  LIKE '%$search%' streetname  LIKE '%$search%' barangayname  LIKE '%$search%' cityname  LIKE '%$search%' meterbrandno'  LIKE '%$search%'" ;
